package HomeWork1.Task1_OOP;//Задача 1: Создание класса "Круг"
//Создайте класс HomeWork1.Task1_OOP.Circle, который будет описывать круг с помощью следующих свойств и методов:
